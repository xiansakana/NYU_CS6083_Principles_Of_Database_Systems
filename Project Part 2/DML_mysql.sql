...
INSERT INTO discount_indi (discount_id, disc_perc, start_date, end_date) VALUES (11, 60, STR_TO_DATE('08/01/2023', '%m/%d/%Y'), STR_TO_DATE('11/21/2023', '%m/%d/%Y'));

INSERT INTO discount_indi (discount_id, disc_perc, start_date, end_date) VALUES (12, 65, STR_TO_DATE('09/10/2023', '%m/%d/%Y'), STR_TO_DATE('12/25/2023', '%m/%d/%Y'));

INSERT INTO discount_indi (discount_id, disc_perc, start_date, end_date) VALUES (13, 15, STR_TO_DATE('10/01/2023', '%m/%d/%Y'), STR_TO_DATE('11/18/2023', '%m/%d/%Y'));

INSERT INTO discount_indi (discount_id, disc_perc, start_date, end_date) VALUES (14, 25, STR_TO_DATE('10/08/2023', '%m/%d/%Y'), STR_TO_DATE('11/24/2023', '%m/%d/%Y'));

INSERT INTO discount_indi (discount_id, disc_perc, start_date, end_date) VALUES (15, 12, STR_TO_DATE('10/15/2023', '%m/%d/%Y'), STR_TO_DATE('11/25/2023', '%m/%d/%Y'));

INSERT INTO discount_indi (discount_id, disc_perc, start_date, end_date) VALUES (16, 35, STR_TO_DATE('10/23/2023', '%m/%d/%Y'), STR_TO_DATE('11/29/2023', '%m/%d/%Y'));

INSERT INTO discount_indi (discount_id, disc_perc, start_date, end_date) VALUES (17, 11, STR_TO_DATE('11/01/2023', '%m/%d/%Y'), STR_TO_DATE('01/21/2024', '%m/%d/%Y'));

INSERT INTO discount_indi (discount_id, disc_perc, start_date, end_date) VALUES (18, 18, STR_TO_DATE('11/01/2023', '%m/%d/%Y'), STR_TO_DATE('01/27/2024', '%m/%d/%Y'));

INSERT INTO discount_indi (discount_id, disc_perc, start_date, end_date) VALUES (19, 22, STR_TO_DATE('11/01/2023', '%m/%d/%Y'), STR_TO_DATE('01/25/2024', '%m/%d/%Y'));

INSERT INTO discount_indi (discount_id, disc_perc, start_date, end_date) VALUES (20, 16, STR_TO_DATE('11/01/2023', '%m/%d/%Y'), STR_TO_DATE('02/12/2024', '%m/%d/%Y'));
...
INSERT INTO jc_invoice (invoice_id, invoice_date, invoice_amount, service_id) VALUES (1, STR_TO_DATE('11/1/2023', '%m/%d/%Y'), 286.05, 20);

INSERT INTO jc_invoice (invoice_id, invoice_date, invoice_amount, service_id) VALUES (2, STR_TO_DATE('11/1/2023', '%m/%d/%Y'), 260.32, 18);

INSERT INTO jc_invoice (invoice_id, invoice_date, invoice_amount, service_id) VALUES (3, STR_TO_DATE('11/2/2023', '%m/%d/%Y'), 458.65, 19);

INSERT INTO jc_invoice (invoice_id, invoice_date, invoice_amount, service_id) VALUES (4, STR_TO_DATE('11/3/2023', '%m/%d/%Y'), 364.14, 1);

INSERT INTO jc_invoice (invoice_id, invoice_date, invoice_amount, service_id) VALUES (5, STR_TO_DATE('11/5/2023', '%m/%d/%Y'), 176.61, 2);

INSERT INTO jc_invoice (invoice_id, invoice_date, invoice_amount, service_id) VALUES (6, STR_TO_DATE('11/5/2023', '%m/%d/%Y'), 412.26, 17);

INSERT INTO jc_invoice (invoice_id, invoice_date, invoice_amount, service_id) VALUES (7, STR_TO_DATE('11/7/2023', '%m/%d/%Y'), 424.74, 16);

INSERT INTO jc_invoice (invoice_id, invoice_date, invoice_amount, service_id) VALUES (8, STR_TO_DATE('11/7/2023', '%m/%d/%Y'), 120.17, 3);

INSERT INTO jc_invoice (invoice_id, invoice_date, invoice_amount, service_id) VALUES (9, STR_TO_DATE('11/7/2023', '%m/%d/%Y'), 365.60, 4);

INSERT INTO jc_invoice (invoice_id, invoice_date, invoice_amount, service_id) VALUES (10, STR_TO_DATE('11/8/2023', '%m/%d/%Y'), 401.10, 15);

INSERT INTO jc_invoice (invoice_id, invoice_date, invoice_amount, service_id) VALUES (11, STR_TO_DATE('11/9/2023', '%m/%d/%Y'), 491.33, 9);

INSERT INTO jc_invoice (invoice_id, invoice_date, invoice_amount, service_id) VALUES (12, STR_TO_DATE('11/10/2023', '%m/%d/%Y'), 390.93, 5);

INSERT INTO jc_invoice (invoice_id, invoice_date, invoice_amount, service_id) VALUES (13, STR_TO_DATE('11/10/2023', '%m/%d/%Y'), 486.97, 6);

INSERT INTO jc_invoice (invoice_id, invoice_date, invoice_amount, service_id) VALUES (14, STR_TO_DATE('11/10/2023', '%m/%d/%Y'), 351.70, 13);

INSERT INTO jc_invoice (invoice_id, invoice_date, invoice_amount, service_id) VALUES (15, STR_TO_DATE('11/11/2023', '%m/%d/%Y'), 251.70, 14);

INSERT INTO jc_invoice (invoice_id, invoice_date, invoice_amount, service_id) VALUES (16, STR_TO_DATE('11/12/2023', '%m/%d/%Y'), 428.99, 7);

INSERT INTO jc_invoice (invoice_id, invoice_date, invoice_amount, service_id) VALUES (17, STR_TO_DATE('11/13/2023', '%m/%d/%Y'), 183.92, 8);

INSERT INTO jc_invoice (invoice_id, invoice_date, invoice_amount, service_id) VALUES (18, STR_TO_DATE('11/14/2023', '%m/%d/%Y'), 114.53, 12) ;

INSERT INTO jc_invoice (invoice_id, invoice_date, invoice_amount, service_id) VALUES (19, STR_TO_DATE('11/14/2023', '%m/%d/%Y'), 362.90, 11);

INSERT INTO jc_invoice (invoice_id, invoice_date, invoice_amount, service_id) VALUES (20, STR_TO_DATE('11/15/2023', '%m/%d/%Y'), 172.14, 10);
